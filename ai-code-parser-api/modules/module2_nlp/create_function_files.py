...
print("Processing ..\..\user_code.c...")
try:
    with open("..\..\user_code.c", "r") as file:
        content = file.read()
    cleaned = remove_main_function(content)
    with open("user_code_func.c", "w") as out:
        out.write(cleaned)
    print("Created user_code_func.c")
except Exception as e:
    print("Error processing ..\..\user_code.c: {e}")

print("\nFunction-only files created in current directory!")
print("Now run: gcc -o test_runner test_runner.c user_code_func.c -lm")
