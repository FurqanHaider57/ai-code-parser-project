...
// Unit tests for integer_sqrt from factorial.c
void test_integer_sqrt_factorial() {
    printf("\n=== Testing integer_sqrt from factorial.c ===\n");
    int passed = 0, total = 0;

    // Functional Tests
    // Test integer_sqrt with valid integer n
    printf("TODO: Test integer_sqrt with valid integer n\n");
    // passed++; total++; // Uncomment when implemented

    // Boundary Tests
    // Test integer_sqrt with n = 0
    printf("TODO: Test integer_sqrt with n = 0\n");
    // passed++; total++; // Uncomment when implemented

    // Error Tests
    // Test integer_sqrt with negative n
    printf("TODO: Test integer_sqrt with negative n\n");
    // passed++; total++; // Uncomment when implemented

    // Performance Tests
    printf("Function integer_sqrt: %d/%d tests passed\n", passed, total);
}
...
void run_all_tests() {
    ...
    printf("Functions discovered: 6\n\n");

    test_factorial_factorial();
    test_fibonacci_factorial();
    test_add_factorial();
    test_integer_sqrt_factorial();
